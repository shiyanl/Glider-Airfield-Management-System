...
class GfsaFlightRecords(models.Model):
    ...
    xerorecord_xr = models.ForeignKey('GfsaXeroRecord', db_column='XeroRecord_xr_id', blank=True,
    ...
    fr_created = models.DateTimeField()
    fr_last_updated = models.DateTimeField()
