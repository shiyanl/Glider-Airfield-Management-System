...
class Migration(SchemaMigration):
    ...
    models = {
        u'flight.gfsaflightrecords': {
            ...
            'glider_glider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['glider.GfsaGliders']", 'db_column': "'Glider_glider_id'"}),
            'tug_tug': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tug.GfsaTugs']", 'db_column': "'Tug_tug_id'"})
        },
