...
class GfsaGliders(models.Model):
    ...
    glider_initial_flights = models.IntegerField(default=0, blank=False, null=False,verbose_name="Initial Launches", help_text='Type in the history launches ')
    glider_initial_flying_hour = models.IntegerField(default=0, blank=False, null=False,verbose_name="Initial Flying Hours", help_text='Type in the history flying hours ')
