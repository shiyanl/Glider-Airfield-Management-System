...
class GfsaGliders(models.Model):
    ...
    glider_owner = models.CharField(max_length=500, blank=True, null=False, verbose_name="Owner")
    glider_club = models.ForeignKey(GfsaClubs,blank=True,null=True)
    glider_member = models.ForeignKey(GFSAXeroContactPerson,blank=True,null=True)
    ...
    glider_seat_type = models.CharField(choices=SEAT_TYPE,default='2',max_length=45,blank=False,null=False,verbose_name="Seating Type")
